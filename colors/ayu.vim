...
let s:palette.bg        = {'dark': "#263238",  'light': "#FAFAFA",  'mirage': "#263238"}
...
let s:palette.guide     = {'dark': "#3D4751",  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#242B38"}
let s:palette.selection = {'dark': "#607080",  'light': "#F0EEE4",  'mirage': "#343F4C"}
